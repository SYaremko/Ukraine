...
<%@include file="include/right.jsp"%>
    ...
    <div id="block-content">
        ...
        <div id="block-sorting">
            <p id="nav-breadcrumbs"><a href="/index">Головна сторінка</a>\<span>Всі товари</span></p>
            <ul id="option-list">
                <li>Вид:</li>
        ...
        <ul id="block-tovar-grid">
            <c:forEach items="${allProducts}" var="products">
                <li id="block-tovar-grid-new">
                    ...
                    <p class="style-title-grid"><a href="<%--/detProduct-${products.id}--%>">${products.title}</a> </p>
                    <%--<ul class="reviews-and-count-grid">
                        <li><img src="/image/eye-icon.png"><p>0</p> </li>
                        <li><img src="/image/comment-icon.png"><p>0</p></li>
                    </ul>--%>
                    <abbr title="Добавити в корзину"><a class="add-cart-style-grid" tid="${products.id}" ><img src="/image/add-cart-norm.png"></a></abbr>
        ...
        <ul id="block-tovar-list">
            <c:forEach items="${allProducts}" var="products">
                <li id="block-tovar-list-new">
                    ...
                    <p class="style-title-list"><a href="<%--/detProduct-${products.id}--%>">${products.title}</a> </p>
